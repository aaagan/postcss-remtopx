...
describe("remtopx", function() {
  ...
  it("should replace the px unit with rem", function() {
    ...
    var expected = ".rule { font-size: 16px }";
  ...
  it("should handle < 1 values and values without a leading 0 - legacy", function() {
    var rules = ".rule { margin: 0.5rem 0.03125rem -0.0125rem -.2em }";
    var expected  = ".rule { margin: 8px 0.5px -0.2px -.2em }";
    var options = {
...
describe("value parsing", function() {
  ...
  it("should not replace values in `url()` - legacy", function() {
    ...
    var expected = ".rule { background: url(16px.jpg); font-size: 16px; }";
    var rules = ".rule { background: url(16px.jpg); font-size: 1rem; }";
    var processed = postcss(remtopx(options)).process(rules).css;
...
describe("rootValue", function() {
  ...
  it("should replace using a root value of 10 - legacy", function() {
    var expected = ".rule { font-size: 10px }";
    var options = {
      root_value: 10
    };
  ...
  it("should replace using different root values with different files", function() {
    var css1 = ".rule { font-size: 1.3333333rem }";
    var css2 = ".rule { font-size: 1rem }";
    var expected = ".rule { font-size: 20px }";
    var options = {
    ...
    var processed1 = postcss(remtopx(options)).process(css1, {
      from: "/tmp/basic.css"
    }).css;
    var processed2 = postcss(remtopx(options)).process(css2, {
...
describe("propWhiteList", function() {
  ...
  it("should only replace properties in the white list - legacy", function() {
    var expected = ".rule { margin: 16px; margin-left: 10px }";
    var css = ".rule { margin: 1rem; margin-left: 10px }";
    var options = {
      propWhiteList: ["margin"]
    };
    var processed = postcss(remtopx(options)).process(css).css;
...
describe("selectorBlackList", function() {
  ...
  it("should ignore selectors in the selector black list - legacy", function() {
    var expected = ".rule { font-size: 15px } .rule2 { font-size: 15px }";
    var rules = ".rule { font-size: 0.9375rem } .rule2 { font-size: 15px }";
    var options = {
...
describe("mediaQuery", function() {
  ...
  it("should replace px in media queries", function() {
    ...
    var processed = postcss(remtopx(options)).process(
...
describe("minPixelValue", function() {
  it("should not replace values below minPixelValue", function() {
    ...
    var expected =
      ".rule { border: 1px solid #000; font-size: 16px; margin: 1px 0.625rem; }";
...
describe("exclude", function() {
  it("should ignore file path with exclude RegEx", function() {
    ...
    var processed = postcss(remtopx(options)).process(basicCSS, {
      from: "exclude/path"
    }).css;
